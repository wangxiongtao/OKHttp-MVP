...
public class HttpException extends Exception {
    ...
    public static final int SERVER_NO_ERROR_CODE = 0;//服务器响应无错误
    ...
    public static final int RESULT_NO_ERROR_CODE = -5;//返回BaseResult.code=0000(结果无错误)
    ...
    public String getUrl() {
        return okResponse == null ? url : okResponse.getResponse().request().url().toString();
    }
